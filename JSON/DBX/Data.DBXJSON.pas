...
type
  ...
  public
    ...
    class function ParseJSONValueUTF8(const Data: TBytes; const Offset: Integer;
                                      const Count: Integer): TJSONValue; overload; static; deprecated;
    /// <summary> deprecated.  Use ParseJSONValue</summary>
    class function ParseJSONValueUTF8(const Data: TBytes;
                                      const Offset: Integer): TJSONValue; overload; static; deprecated;
  ...
  public
    ...
    /// <seealso cref="TJSONAncestor.toBytes(TBytes,Integer)"/>
...
constructor TDBXNamedCallback.Create(const Name: UnicodeString);
begin
  inherited Create;
  self.FName := Name;
end;

function TDBXNamedCallback.GetName: UnicodeString;
begin
  Result := FName;
end;
...
begin
  inherited Create;
  FStrBuffer := TDBXStringBuffer.Create(Value);
end;
